...
const SvgMikrofonFill = forwardRef(
  (
    {
      size,
      title,
    ...
    return (
      ...
      >
        ...
        <path
          ...
          strokeMiterlimit={10}
          strokeWidth={0.4}
          d="M40.027 12.836c-1.37 1.636-3.504 2.41-5.29 2.577 0 0-2.29-1.875-3.706-3.06s-3.669-3.127-3.669-3.127a7.208 7.208 0 1 1 12.665 3.61Z"
        />
        <path
          fill="#76C69D"
          stroke="#303030"
          strokeMiterlimit={10}
          strokeWidth={0.4}
          d="M14.046 37.158 9.6 33.436l17.41-23.68 7.285 6.099z"
        />
        <path
          fill="#7F99AE"
          stroke="#303030"
          strokeMiterlimit={10}
          strokeWidth={0.4}
          d="m12.316 38.718-3.948-3.305.906-1.48 4.34 3.633z"
        />
        <path
          fill="#BED5E8"
          stroke="#303030"
...
export default SvgMikrofonFill;

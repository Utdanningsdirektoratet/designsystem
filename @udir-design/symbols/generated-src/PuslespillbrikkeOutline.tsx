...
const SvgPuslespillbrikkeOutline = forwardRef(
  (
    {
      size,
      title,
    ...
    return (
      ...
      >
        ...
        <g clipPath="url(#PuslespillbrikkeOutline_svg__a)">
          <path
            stroke="#303030"
            strokeMiterlimit={10}
            strokeWidth={0.4}
        ...
        <defs>
          <clipPath id="PuslespillbrikkeOutline_svg__a">
...
export default SvgPuslespillbrikkeOutline;

...
const SvgMattePlusstegnOutline = forwardRef(
  (
    {
      size,
      title,
    ...
    return (
      ...
      >
        ...
        <mask id="MattePlusstegnOutline_svg__a" fill="#fff">
        ...
        <path
          ...
          mask="url(#MattePlusstegnOutline_svg__a)"
        />
      </svg>
    );
  },
);
export default SvgMattePlusstegnOutline;

...
const SvgBallongerFill = forwardRef(
  (
    {
      size,
      title,
    ...
    return (
      ...
      >
        ...
        <path
          stroke="#303030"
          strokeWidth={0.4}
          d="M16.704 17.847c.129 1.564.12 2.689 0 4.03-.15 1.679-1.233 5.352-.556 8.204.678 2.853 1.168 4.476.556 10.919"
        />
        <path
          fill="#BED5E8"
          stroke="#303030"
          strokeWidth={0.4}
          d="M23.761 18.645c1.012 1.967 2.714 4.43 4.894 4.43 2.054 0 3.637-2.579 4.592-4.574.954-1.996 1.867-6.33.257-9.047-1.811-3.058-8.128-2.728-10.07 0-1.94 2.727-.908 6.791.327 9.191Z"
        />
        <path
          fill="#BED5E8"
          stroke="#303030"
        ...
        <path
          stroke="#303030"
          strokeWidth={0.4}
          d="M28.733 24.13c-.696 3.537.633 5.24 0 8.362-.583 2.873 0 5.65 0 8.508"
        />
        <path
          fill="#E5CEAE"
          stroke="#303030"
          strokeWidth={0.4}
          d="M2.406 24.052c1.012 1.967 2.714 4.43 4.894 4.43 2.054 0 3.637-2.58 4.591-4.574.955-1.996 1.868-6.33.258-9.048-1.812-3.058-8.129-2.727-10.07 0-1.94 2.728-.909 6.792.327 9.192Z"
        />
        <path
          fill="#E5CEAE"
          stroke="#303030"
...
export default SvgBallongerFill;

...
const SvgMattePlusstegnBl = forwardRef(
  (
    {
      size,
      title,
    ...
    return (
      ...
      >
        ...
        <mask id="MattePlusstegnBl\xE5_svg__a" fill="#fff">
          <path d="M25 17h16v8H25v16h-8V25H1v-8h16V1h8z" />
        </mask>
        <path fill="#BED5E8" d="M25 17h16v8H25v16h-8V25H1v-8h16V1h8z" />
        <path
          fill="#303030"
          ...
          mask="url(#MattePlusstegnBl\xE5_svg__a)"
        />
      </svg>
    );
  },
);
export default SvgMattePlusstegnBl;

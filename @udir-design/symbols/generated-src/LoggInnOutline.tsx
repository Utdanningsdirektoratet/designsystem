...
const SvgLoggInnOutline = forwardRef(
  (
    {
      size,
      title,
    ...
    return (
      ...
      >
        ...
        <path
          ...
          strokeMiterlimit={10}
          strokeWidth={0.4}
          d="M30.635 20.207 21.358 9.76c-.115-.2-.41-.116-.41.121v2.13c0 .13-.096.233-.22.233H1.226c-.287 0-.313 16.17 0 16.17H20.73c.123 0 .22.103.22.234v2.13c0 .237.294.321.409.12l9.277-10.447a.24.24 0 0 0 0-.243Z"
        />
      </svg>
    );
  },
);
export default SvgLoggInnOutline;

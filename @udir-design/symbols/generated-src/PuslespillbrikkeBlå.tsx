...
const SvgPuslespillbrikkeBl = forwardRef(
  (
    {
      size,
      title,
    ...
    return (
      ...
      >
        ...
        <g clipPath="url(#PuslespillbrikkeBl\xE5_svg__a)">
          <path
            fill="#BED5E8"
            stroke="#303030"
            strokeMiterlimit={10}
        ...
        <defs>
          <clipPath id="PuslespillbrikkeBl\xE5_svg__a">
...
export default SvgPuslespillbrikkeBl;

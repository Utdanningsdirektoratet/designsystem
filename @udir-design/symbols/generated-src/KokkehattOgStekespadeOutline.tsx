...
const SvgKokkehattOgStekespadeOutline = forwardRef(
  (
    {
      size,
      title,
    ...
    return (
      ...
      >
        ...
        <g
          stroke="#303030"
          strokeMiterlimit={10}
          clipPath="url(#KokkehattOgStekespadeOutline_svg__a)"
        >
          <path
            strokeWidth={0.4}
            d="M23.691 22.84c.53-1.014.152-3.685-.177-4.534-.33-.849 1.73-3.27-.081-6.179-1.568-2.519 3.564-6.362 1.972-8.523-1.593-2.162-6.335-.183-7.603-2.112-1.27-1.93-6.868 2.321-8.616 4.054-2.022 2.006-2.364-.266-4.932.585S2.908 11 1.311 11.691s3.448 4.115 3.892 5.373c.445 1.258-.49 2.055-.354 2.888.138.833 2.452 4.64 2.452 4.64l.615.691"
          />
          <path
            strokeWidth={0.4}
        ...
        <defs>
          <clipPath id="KokkehattOgStekespadeOutline_svg__a">
...
export default SvgKokkehattOgStekespadeOutline;

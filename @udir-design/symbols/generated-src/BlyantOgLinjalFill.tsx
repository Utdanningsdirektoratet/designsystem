...
const SvgBlyantOgLinjalFill = forwardRef(
  (
    {
      size,
      title,
    ...
    return (
      ...
      >
        ...
        <path
          ...
          strokeMiterlimit={10}
          strokeWidth={0.2}
          d="m11.144 31.007-1.66-.237M11.419 34.988l-2.486-.353M12.517 27.259l-2.486-.353M14.714 11.802l-2.486-.353M14.439 7.821l-1.66-.237M12.243 23.278l-1.661-.236M13.616 19.53l-2.486-.353M13.34 15.55l-1.66-.237"
        />
        <path
          fill="#5BA27E"
          stroke="#303030"
        ...
        <path
          ...
          strokeMiterlimit={10}
          strokeWidth={0.4}
          d="m24.828 37.137.762 2.207.782-2.202z"
        />
        <path
          fill="#BED5E8"
          stroke="#303030"
          strokeMiterlimit={10}
          strokeWidth={0.4}
          d="m25.165 2.405 1.186.005a1.33 1.33 0 0 1 1.323 1.335l-.006 1.384q0 .001-.004.003l-3.831-.017-.003-.003.006-1.388c.004-.73.6-1.321 1.33-1.318z"
        />
      </svg>
    );
  },
);
export default SvgBlyantOgLinjalFill;

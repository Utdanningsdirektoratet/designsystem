...
const SvgPuslespillbrikkeBrun = forwardRef(
  (
    {
      size,
      title,
    ...
    return (
      ...
      >
        ...
        <g clipPath="url(#PuslespillbrikkeBrun_svg__a)">
          <path
            fill="#E5CEAE"
            stroke="#303030"
            strokeMiterlimit={10}
        ...
        <defs>
          <clipPath id="PuslespillbrikkeBrun_svg__a">
...
export default SvgPuslespillbrikkeBrun;

...
const SvgVerdenOutline = forwardRef(
  (
    {
      size,
      title,
    ...
    return (
      ...
      >
        ...
        <g
          stroke="#303030"
          strokeMiterlimit={10}
          clipPath="url(#VerdenOutline_svg__a)"
        >
          <path
            strokeWidth={0.4}
...
export default SvgVerdenOutline;

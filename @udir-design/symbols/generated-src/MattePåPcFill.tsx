...
const SvgMattePPcFill = forwardRef(
  (
    {
      size,
      title,
    ...
    return (
      ...
      >
        ...
        <path
          ...
          stroke="#303030"
          strokeWidth={0.2}
          d="M26.561 6.498v1.468h-8.139V6.498zM22.492 3.16a.943.943 0 1 1-.001 1.886.943.943 0 0 1 0-1.885ZM22.492 9.415a.943.943 0 1 1 0 1.886.943.943 0 0 1 0-1.886Z"
        />
        <mask id="MatteP\xE5PcFill_svg__a" fill="#fff">
          <path d="M14.088 11.567h2.807v1.403h-2.807v2.805h-1.403V12.97H9.879v-1.403h2.806V8.761h1.403z" />
        </mask>
        <path
          fill="#E5CEAE"
          d="M14.088 11.567h2.807v1.403h-2.807v2.805h-1.403V12.97H9.879v-1.403h2.806V8.761h1.403z"
        />
        <path
          fill="#303030"
          ...
          mask="url(#MatteP\xE5PcFill_svg__a)"
        />
        <path
          fill="#BED5E8"
          stroke="#303030"
...
export default SvgMattePPcFill;

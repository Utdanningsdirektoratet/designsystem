...
const SvgBlyantOutline = forwardRef(
  (
    {
      size,
      title,
    ...
    return (
      ...
      >
        ...
        <path
          ...
          strokeMiterlimit={10}
          strokeWidth={0.4}
          d="m2.185 37.596-.24 2.653 1.844-1.925zM20.016 2.186a1.516 1.516 0 0 1 .751 2.007l-.654 1.437-.005.002-3.977-1.81-.002-.005.656-1.44a1.51 1.51 0 0 1 2-.75z"
        />
      </svg>
    );
  },
);
export default SvgBlyantOutline;

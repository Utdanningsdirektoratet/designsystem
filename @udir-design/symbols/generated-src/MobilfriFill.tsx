...
const SvgMobilfriFill = forwardRef(
  (
    {
      size,
      title,
    ...
    return (
      ...
      >
        ...
        <path
          ...
          strokeMiterlimit={10}
          strokeWidth={0.254}
          d="M25.361 7.984h-8.669c-.952 0-1.724.772-1.724 1.724v21.949c0 .952.772 1.724 1.724 1.724h8.67c.952 0 1.724-.772 1.724-1.724V9.708c0-.952-.772-1.724-1.725-1.724Z"
        />
        <path
          fill="#303030"
          stroke="#303030"
          strokeMiterlimit={10}
          strokeWidth={0.254}
          d="M26.207 9.932H15.848a.317.317 0 0 0-.317.318v19.5c0 .175.142.317.317.317h10.36a.317.317 0 0 0 .317-.317v-19.5a.317.317 0 0 0-.318-.318Z"
        />
        <path
          fill="#303030"
          stroke="#303030"
        ...
        />
        <mask id="MobilfriFill_svg__a" fill="#fff">
          <path
            fillRule="evenodd"
        ...
        <path
          ...
          mask="url(#MobilfriFill_svg__a)"
        />
      </svg>
    );
  },
);
export default SvgMobilfriFill;

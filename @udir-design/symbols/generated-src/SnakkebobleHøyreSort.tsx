...
const SvgSnakkebobleHyreSort = forwardRef(
  (
    {
      size,
      title,
    ...
    return (
      ...
      >
        ...
        <g clipPath="url(#SnakkebobleH\xF8yreSort_svg__a)">
          <path
            fill="#303030"
            stroke="#303030"
            strokeWidth={0.4}
        ...
        <defs>
          <clipPath id="SnakkebobleH\xF8yreSort_svg__a">
...
export default SvgSnakkebobleHyreSort;

...
const SvgSnakkebobleHyreGrnn = forwardRef(
  (
    {
      size,
      title,
    ...
    return (
      ...
      >
        ...
        <g clipPath="url(#SnakkebobleH\xF8yreGr\xF8nn_svg__a)">
          <path
            fill="#76C69D"
            stroke="#303030"
            strokeWidth={0.4}
        ...
        <defs>
          <clipPath id="SnakkebobleH\xF8yreGr\xF8nn_svg__a">
...
export default SvgSnakkebobleHyreGrnn;

...
const SvgSamtalePPcFill = forwardRef(
  (
    ...
    return (
      ...
      >
        ...
        />
        <path stroke="#303030" strokeWidth={0.2} d="M2.12 24.871h37.757" />
        <path
          fill="#ECDBC2"
          stroke="#303030"
          strokeWidth={0.2}
          d="M21.884 9.081c1.24-1.582 4.202-1.84 7.566-1.146 3.887.801 3.176 5.429.506 6.218-1.23.364-4.692.046-4.958.207-.181.69-1.223 1.528-2.415 1.81.232-.332.646-1.043.778-1.81-2.669-.45-2.947-3.404-1.477-5.279Z"
        />
        <path
          fill="#A9DBC2"
          stroke="#303030"
          strokeWidth={0.2}
          d="M19.857 5.216c-1.24-1.582-4.202-1.84-7.566-1.147-3.886.802-3.176 5.43-.506 6.219 1.231.363 4.692.046 4.959.207.18.69 1.223 1.528 2.414 1.81-.232-.332-.646-1.043-.778-1.81 2.669-.451 2.947-3.404 1.477-5.28Z"
        />
      </svg>
    );
  },
);
export default SvgSamtalePPcFill;

...
const SvgMattePlusstegnBrun = forwardRef(
  (
    {
      size,
      title,
    ...
    return (
      ...
      >
        ...
        <mask id="MattePlusstegnBrun_svg__a" fill="#fff">
          <path d="M25 17h16v8H25v16h-8V25H1v-8h16V1h8z" />
        </mask>
        <path fill="#E5CEAE" d="M25 17h16v8H25v16h-8V25H1v-8h16V1h8z" />
        <path
          fill="#303030"
          ...
          mask="url(#MattePlusstegnBrun_svg__a)"
        />
      </svg>
    );
  },
);
export default SvgMattePlusstegnBrun;

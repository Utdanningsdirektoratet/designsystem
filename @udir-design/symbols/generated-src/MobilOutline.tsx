...
const SvgMobilOutline = forwardRef(
  (
    {
      size,
      title,
    ...
    return (
      ...
      >
        ...
        <path
          ...
          strokeMiterlimit={10}
          strokeWidth={0.3}
          d="M12.302 2.325H8.785a.24.24 0 0 0 0 .482h3.517a.24.24 0 1 0 0-.482ZM10.543 39.595a1.33 1.33 0 1 0 0-2.66 1.33 1.33 0 0 0 0 2.66Z"
        />
      </svg>
    );
  },
);
export default SvgMobilOutline;

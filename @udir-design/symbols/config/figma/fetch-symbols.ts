...
const FIGMA_FILE_KEY = 'SSdGSjSYPDSyX2IfHLfmEL';

export const fetchSymbols = async (): Promise<PublishedComponent[]> => {
  console.group('Fetching list of published symbols from Figma...');
  const data:
    | GetFileComponentsResponse

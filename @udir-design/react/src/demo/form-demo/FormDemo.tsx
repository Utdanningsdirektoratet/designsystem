...
export const FormDemo = ({
  ...
  const formNavigationContent = (
    <FormNavigation>
      ...
      >
        <FormNavigation.Group.Step {...getStepProps('personal')}>
          Personopplysninger
        </FormNavigation.Group.Step>
        <FormNavigation.Group.Step {...getStepProps('ranking')}>
          Rangering
        </FormNavigation.Group.Step>
        <FormNavigation.Group.Step {...getStepProps('finish')}>
          Avslutning
        </FormNavigation.Group.Step>
        <FormNavigation.Group.Step {...getStepProps('deliver')}>
          Innsending
        </FormNavigation.Group.Step>
      </FormNavigation.Group>
    </FormNavigation>
        ...
        <div {...props} className={classes.container}>
          ...
          <form className={classes.form} onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className={classes.navigateButtons}>
              ...
              {id === 'deliver' && (
                <Button autoFocus style={{ flex: 2 }} onClick={onDeliver}>
                  Send inn skjema
                </Button>
              )}
            </div>

import { Table } from './beta';

const data = [
  {
    use: 'Topp- og bunnmargin i toppfelt og bunnfelt',
    token: '--ds-size-5',
    px: '20px',
    comment: 'Gjelder også høyre/venstre-marg',
  },
  {
  ...
  {
    use: 'Side-marg ved interntjenester',
    token: '--ds-size-5',
    px: '20px',
    comment: 'Gjelder høyre og venstre marg',
  },
  {
    use: 'Side-marg ved publikumstjenester',
    token: '--ds-size-16',
    px: '64px',

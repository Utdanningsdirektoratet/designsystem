...
Les også <Link href="./typedoc/modules/utilities_dataVisualization_alpha.html" target="_none">detaljert dokumentasjon generert fra kildekoden (på engelsk)</Link>.

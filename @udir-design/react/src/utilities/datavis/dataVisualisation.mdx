...
<SimpleAlert type="warning">
  Den divergerende paletten er under arbeid. Fargene kan endres eller fjernes i
  nær fremtid.
</SimpleAlert>
...
Fargepalettene skal fungere med de fleste diagrambiblioteker som lar deg spesifisere farger via CSS eller JavaScript. Her er et eksempel på hvordan du kan bruke `getCategoricalColors()` med Recharts:

...
describe('generateSequentialDivergentColors', () => {
  it('returns correct number of colors', () => {
    ...
    expect(generateSequentialDivergentColors(15)).toHaveLength(15);
  });
  ...
  it('throws RangeError for count below 3 or even count', () => {
    ...
    expect(() => generateSequentialDivergentColors(4)).toThrow(RangeError);
    expect(() => generateSequentialDivergentColors(6)).toThrow(RangeError);
    expect(() => generateSequentialDivergentColors(10)).toThrow(RangeError);
  });

  it('throws RangeError for decimal count', () => {
    expect(() => generateSequentialDivergentColors(7.1)).toThrow(RangeError);
  });

  it('returns the same color sequence each call', () => {
    expect(generateSequentialDivergentColors(11)).toEqual(
      generateSequentialDivergentColors(11),
    );
  });

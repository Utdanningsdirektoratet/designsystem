...
**Viktig:** Importer CSS for datavisualiseringsfarger i applikasjonen din:
...
**Språkstøtte:** Highcharts har noen få innebygde språkpakker. Engelsk er standard. Importer andre du trenger:

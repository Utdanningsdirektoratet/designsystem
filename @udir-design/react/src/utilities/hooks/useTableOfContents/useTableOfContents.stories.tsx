  ...
  render() {
    return (
      <div className={styles.prose}>
        ...
        <Heading level={2} id="first-heading">
          Første overskrift (h2)
        </Heading>
        <Heading level={3} id="first-subheading">
          Første underoverskrift (h3)
        </Heading>
        <Heading level={2} id="second-heading">
          Andre overskrift (h2)
        </Heading>
      </div>
    );
  ...
  render() {
    ...
    return (
      <div ref={containerRef} className={styles.prose}>
        <Heading level={1} id="sidetittel" data-size="xl">
          Sidetittel (h1)
        </Heading>
        ...
        <Heading level={2} id="forste-overskrift" data-size="lg">
          Første overskrift (h2)
        </Heading>
        <Paragraph>
        ...
        <Heading level={3} id="forste-underoverskrift" data-size="md">
          Første underoverskrift (h3)
        </Heading>
        <Paragraph>
        ...
        <Heading level={4} id="forste-underunderoverskrift" data-size="sm">
        ...
        <Heading level={2} id="andre-overskrift" data-size="lg">
          Andre overskrift (h2)
        </Heading>
        <Paragraph>
...
export const TocIgnore: Story = {
  render() {
    return (
      <div className={styles.prose}>
        <TableOfContents {...useTableOfContents()} />
        <Heading level={2} id="inkluder-overskrift-1">
          Inkluder første overskrift (h2)
        </Heading>
        <Heading level={2} id="utelat-overskrift-2" data-toc-ignore>
          Utelat andre overskrift (h2)
        </Heading>
        <Heading level={2} id="inkluder-overskrift-3">

...
const automaticBase = {
  ...
  render: (args: TableOfContentsProps) => (
    <Prose>
      ...
      <Paragraph>
        ...
        felis in, vulputate condimentum turpis.
      </Paragraph>
      <Paragraph>
      ...
      <Paragraph>
        ...
        vestibulum id iaculis fermentum, ornare a nisi.
      </Paragraph>
...
export const Automatic = meta.story(automaticBase);

export const DefaultClosed = meta.story({
  ...automaticBase,
  args: {
    ...automaticBase.args,
    defaultClosed: true,

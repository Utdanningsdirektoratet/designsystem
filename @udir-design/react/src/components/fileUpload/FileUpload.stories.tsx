...
export type Story = StoryObj<typeof FileUpload.Compact>;

const meta: Meta<typeof FileUpload.Compact> = {
  component: FileUpload.Compact,
  tags: ['alpha', 'udir'],
  parameters: {
    componentOrigin: {
      originator: 'self',
...
export const ExampleCompact: Story = {
  render: (args) => {

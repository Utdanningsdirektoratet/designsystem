...
Du kan bruke alle identitetsfargene på `Avatar`.
...
Bruk gjennkjennelige ikoner i `Avatar` for å representere forskjellige typer brukere eller enheter. For vanlige roller anbefaler vi å bruke ikoner fra eksempelet under.

<Canvas of={AvatarStories.Icons} />

...
Standardteksten på lukkeknappen støtter bokmål, nynorsk og engelsk. [Slik støtter du flere språk](/docs/components-språkstøtte--docs). En verdi du sender til `closeButton` overstyrer standardteksten.

<CssLanguageVariables variables={['--udsc-dialog-close-label']} />

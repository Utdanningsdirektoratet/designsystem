...
`Alert` skal se lik ut i alle tjenester og produkter, slik at brukerne gjenkjenner den uansett kontekst. Fargene i komponenten er bevisst valgt for å skille seg fra resten av Udir-paletten og fange oppmerksomheten til brukeren.

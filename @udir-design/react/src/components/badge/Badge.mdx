...
Fordi rød er godt etablert som varselfarge viker anbefalt bruk her noe fra standard semantikk for varselfarger. For notifikasjoner anbefales fargen `danger`. For bruk inline anbefales som hovudregel å bruke `neutral`. I enkelte tilfeller kan det være aktuelt å bruke de øvrige verselfargene.
...
<Canvas of={BadgeStories.InTable} />

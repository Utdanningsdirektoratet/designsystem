...
Du kan òg setje `variant` direkte for å endre bakgrunnsfarga til `tinted` variant, som er noko lysare.
...
<OriginText
  component="Badge"
  digdir
  details="Vi har begrenset fargevalg til semantiske- og Udirs hovedfarger."
/>

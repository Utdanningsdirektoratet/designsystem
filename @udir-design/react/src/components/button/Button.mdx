...
<SimpleAlert type="info" heading={{ text: 'Tips', level: 4 }}>
...
Deaktiverte (`disabled`) knapper bør unngås fordi de kan være vanskelige å oppfatte. Noen brukere vil ikke forstå hva knappen sier eller hvorfor den ikke er klikkbar. Bruk heller en aktiv knapp som validerer.

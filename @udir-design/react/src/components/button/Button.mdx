...
Vær oppmerksom på at dersom komponenten brukes i en høyre-til-venstre-kontekst, for eksempel i systemer med støtte for arabisk eller hebraisk, må ikonet speilvendes hvis det peker i en bestemt retning. Rekkefølgen på tekst og ikon blir automatisk byttet når `dir="rtl"` settes på en overordnet komponent.

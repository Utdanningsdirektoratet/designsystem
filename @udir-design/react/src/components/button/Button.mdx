...
I safari desktop blir ikke ikoner i knapp større ved zoom. [Problemet er rapportert inn til digdir](https://github.com/digdir/designsystemet/issues/4038) som har besluttet at dette er noe Safari selv må fikse.

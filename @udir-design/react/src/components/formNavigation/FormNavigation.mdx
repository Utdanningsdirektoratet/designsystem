...
I `FormNavigation.Step` velger du ikoner som tydelig representerer innholdet på siden eller gruppen av sider. [Oversiktssiden for `Ikoner`](/docs/iconsandsymbols-ikoner--ikoner) viser tilgjengelige valg. Bruk følgende ikoner som utgangspunkt:

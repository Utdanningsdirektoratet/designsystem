...
Tittelen legges inn som `children`. Bruk `variant`-propen for å vise riktig ikon automatisk for stegtypen (`variant='info' | 'summary' | 'submission' | 'confirmation' | 'default'`).

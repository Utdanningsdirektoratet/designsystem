...
`ErrorSummary` får automatisk fokus når den dukker opp, slik at brukeren får med seg hva hen må gjøre for å komme videre. Her er et eksempel på hvordan dette fungerer.

...
- Tag er ikke egnet som link til andre sider (bruk heller [link](/docs/components-link--docs)).
- Tag er ikke egnet til handlinger (bruk heller [button](/docs/components-button--docs)).
- For filtrering der brukeren kan filtrere data og bare se elementer innenfor ønsket kategori kan du bruke [Chip](/docs/components-chip--docs).

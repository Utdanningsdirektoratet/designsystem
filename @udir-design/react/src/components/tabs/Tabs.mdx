...
`Tabs` har en "default" variant, som er den mest brukte og fleksible varianten. Den fungerer godt i de fleste situasjoner og gir et rent og enkelt utseende.

<Canvas of={TabsStories.Preview} />

### Card

`Tabs` har også en "card" variant, som gir et mer fremtredende og visuelt skille mellom fanene. Denne varianten passer til å visuelt knytte fanene til innholdet i panelene.

<Canvas of={TabsStories.Card} />

### Vertical

`Tabs` har en "vertical" variant, som plasserer fanene vertikalt i stedet for horisontalt. Denne varianten er nyttig når du for eksempel har mange faner.

<Canvas of={TabsStories.VerticalLeft} />

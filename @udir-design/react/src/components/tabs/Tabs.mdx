...
Noen ganger kan det likevel være nyttig å knytte valgt tab til en URL, uten at det teller som navigasjon. Det kan løses ved bruk av shallow-routing, noe de fleste routing-rammeverk støtter. Under er et eksempel med bruk av Nextjs.

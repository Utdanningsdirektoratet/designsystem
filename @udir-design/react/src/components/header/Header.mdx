...
Logoen i `Header` kan byttes ut med en pride-variant ved å sette `variant="pride"` på `Header`. Varianten brukes i juni for å markere Pride og vise støtte til mangfold.

<Canvas
  story={{ inline: false, height: '90px' }}
  of={HeaderStories.PrideLogo}
/>

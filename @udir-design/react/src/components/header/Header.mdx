import { Meta, Controls, Canvas, Source } from '@storybook/addon-docs/blocks';

import * as HeaderStories from './Header.stories';
import { Table } from '@udir-design/react/beta';
import { Unstyled } from '@storybook/addon-docs/blocks';
import languagePickerSrc from './docs/LanguagePicker.tsx?raw';
...
<Source code={languagePickerSrc} language="tsx" />

Eksempel der språkvalget er en knapp som setter tilstand
...
Eksempel der språkvalget er en lenke til en alternativ versjon av siden

<Canvas
  story={{ inline: false, height: '350px' }}
  of={HeaderStories.WithLinkBasedLanguagePicker}
/>

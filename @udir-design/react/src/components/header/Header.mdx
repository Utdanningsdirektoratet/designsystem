...
Foreldreelementet får automatisk `overflow: visible`. Sørg for at dette ikke blir overskrevet. Ønsker du at headeren ikke skal animeres og bli på toppen av siden ved scroll, setter du `animateHeaderOnScroll=false`.

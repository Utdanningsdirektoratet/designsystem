...
<Meta
  title="bruksmønstre/Feilmeldinger"
  tags={['beta']}
  parameters={{
    componentOrigin: {
      originator: 'digdir',
...
Udir følger [bruksmønster for brukerutløste feilmeldinger utarbeidet i Digdirs 'Designsystemet'](https://designsystemet.no/no/patterns/errors).

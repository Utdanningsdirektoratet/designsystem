...
export const measures: Measure[] = [
  ...
  {
    summary: 'Reguleringsstøtte',
    content:
      'For å utvikle sosial kompetanse, mestre samspill og samarbeid, eller håndtere stress og utfordrende situasjoner, kan elever ha behov for støtte til å regulere følelser og atferd. Dette er spesielt viktig for de elevene som av ulike årsaker har negativ atferd over tid. Å gi reguleringsstøtte handler først og fremst om å forstå elevens opplevelse av situasjonen, og å være i forkant av det som skjer.',
  },
];
